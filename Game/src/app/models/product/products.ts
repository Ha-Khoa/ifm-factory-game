...
export class Products {
    ...
    private static simple_productsList: Product[] = [
        new Product(1, "Raw Plastic"),
        new Product(2, "Raw Silicon"),
        new Product(3, "Copper wire"),
        new Product(4, "Plastic Case"),
        new Product(5, "Circuit Board"),
        new Product(6, "Basic Sensor")
    ]
