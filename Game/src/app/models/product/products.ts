...
export class Products {
  ...
  public static init(): void {
    ...
    this.productsList = [
      ...
      Product.createComplexProduct(4, "Kunststoffgehäuse", 20, 20, [{productId: 1, quantity: 2}], 2, true, "/images/Products/plastic-case.png"),
      Product.createComplexProduct(5, "Platine", 40, 40, [{productId: 2, quantity: 1}, {productId: 18, quantity: 1}], 2, true, "/images/Products/circuit-board.png"),
